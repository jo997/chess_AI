        ...
        if not board.engine_is_selecting:
            ...
            if PLAYER_1 > 1 and color=="white":
                ...
                if PLAYER_1 == 2:
                    ...
                    t = thread_with_trace(target = MrCustom("white").generate_next_move, args=(gui,))
                elif PLAYER_1 == 5:
                    t = thread_with_trace(target = MrBlumGaus("white").generate_next_move, args=(gui,))
                elif PLAYER_1 == 6:
                    t = thread_with_trace(target = MrNovicePruning("white").generate_next_move, args=(gui,))
                elif PLAYER_1 == 7:
                    t = thread_with_trace(target = MrNovicePruningBetter1("white").generate_next_move, args=(gui,))
                elif PLAYER_1 == 8:
                    t = thread_with_trace(target = MrNoviceField("white").generate_next_move, args=(gui,))
                elif PLAYER_1 == 9:
                    t = thread_with_trace(target = MrNoviceEval("white").generate_next_move, args=(gui,))
                ...
                if PLAYER_2 == 2:
                    ...
                    t = thread_with_trace(target = MrBlumGaus("black").generate_next_move, args=(gui,))
                elif PLAYER_2 == 6:
                    t = thread_with_trace(target = MrNovicePruning("black").generate_next_move, args=(gui,))
                elif PLAYER_2 == 7:
                    t = thread_with_trace(target = MrNovicePruningBetter1("black").generate_next_move, args=(gui,))
                elif PLAYER_2 == 8:
                    t = thread_with_trace(target = MrNoviceField("black").generate_next_move, args=(gui,))
                elif PLAYER_2 == 9:
                    t = thread_with_trace(target = MrNoviceEval("black").generate_next_move, args=(gui,))
